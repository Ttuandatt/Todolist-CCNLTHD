import { IsNotEmpty, IsString, Matches, MinLength } from 'class-validator'; // DTO for changing user password
...
export class ChangePasswordDto {
  ...
  }) // Mật khẩu mới phải chứa ít nhất một chữ hoa, một số và một ký tự đặc biệt
